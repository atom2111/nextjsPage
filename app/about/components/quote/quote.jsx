...
export default function Quote() {
	const text1 = '"Нет пределов тому, чего вы можете достичь'.split(" ");
	const text2 = 'за исключением ограничений, которые вы накладываете на свое собственное мышление."'.split(
		" "
	);

				...
				<div className="grid gap-4 relative">
					...
					<div>
						...
						<p className="text-justify">
							Отвечаю за создание и поддержку масштабируемых
							веб-приложений с использованием новейших технологий.
							Сотрудничал с межфункциональными командами для разработки
							высококачественных решений, отвечающих требованиям бизнеса.
						</p>

			...
			<main className="overflow-hidden">
				...
				<div className="relative h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col mb-10 overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 pt-4 backdrop-filter backdrop-blur-sm md:backdrop-blur-none md:backdrop-filter-none bg-gray-100 bg-opacity-50 md:bg-transparent md:pt-0">
						...
						<p className="title text-xl mt-4 tracking-wider text-gray-900 leading-[1.7rem] mb-5">
							<span>Список моих проектов, которые я выполнил,</span><br />
						...
						<motion.div
							...
							className="mb-3">
							<Button variation="primary">Прокрутите вниз</Button>
						</motion.div>
					</div>
				</div>
				<div className="mt-10 flex flex-col justify-start items-center w-full pl-10 md:pl-32">
					<div className="flex justify-center items-center flex-col my-5 self-start ">
						<Hr variant="long"></Hr>
						<h1 className="text-3xl font-bold mt-3">Изюминка</h1>
					</div>
				</div>
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						Веб-сайт для создания викторин, созданный с использованием Next.js Firebase, Next Auth, Google OAuth 
						и TypeScript. 
						Пользователи могут создавать викторины по заранее определенным школьным предметам и отвечать на них 
						в уникальном интерактивном стиле ввода. Приложение поддерживает аутентификацию пользователя в Google 
						и хранит данные в Firestore. Вы можете ознакомиться с исходным кодом этого проекта в моем аккаунте на github 
						или просмотреть проект, нажав на кнопку ниже.
						</p>{" "}
						<div className="mt-3">
							<Button variation="primary">
								<Link href="projects/trivia">Подробнее</Link>
							</Button>
				...
				<div className="mt-16 flex flex-col justify-start items-center w-full pl-10 md:pl-32">
					<div className="flex justify-center items-center flex-col my-5 self-start">
						...
						<motion.h1
							...
							Другие заслуживающие внимания проекты
						</motion.h1>
					</div>
				</div>
				...
				<motion.div
					...
					<Button variation="primary">
						<Link href="projects/archive">Посмотреть в Архиве</Link>
					</Button>
				</motion.div>
			</main>
		</>
